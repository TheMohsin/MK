...
\033[1;93m███▓▒░░._\033[1;97mMOHSIN ALI\033[1;93m_.░░▒▓███►
...
\033[1;91mAuthor©\033[1;91m: \033[1;93mMOHSIN😈 ALI ID NAME MOHSIN RAZA

\033[1;91mYoutube\033[1;91m: \033[1;93mMOHSIN BADSHAH.

\033[1;91mFacebook\033[1;91m: \033[1;93mhttps://www.facebook.com/MOHSIN.ALI.ALL.HATERX.KA.PAPA.FEEL.THE.POWER
\033[1;91m«--------------------\033[1;93m✧\033[1;91m--------------------»"""
jalan("\033[1;97m Please Don't Clone Pakistani Facebook Idz   ")
jalan('\033[1;97m Username Mohsin Password Syco   ')
jalan('\033[1;97m██ 39%  ')
jalan("\033[1;91m ███ 49%  ")
jalan("\033[1;97m  ████ 76%  ")
jalan("\033[1;93m   █████ 89%  ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtu.be/bukJV3JAmUY')
    else:
...
def login():
	...
	try:
		...
		jalan('          \033[1;97mUse a New Account To Login BY MOHSIN ALI' )
...
def pilih_super():
	...
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	jalan(' \033[1;93m Wait AND WATCH Cloned Accounts Will Appear Here MOHSIN ALI BRANDED BOY')
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
             ...
             ( (  \.---./  ) )
              '.__/o   o\__.'
                 {=  ^  =}
                  >  -  <
.-------------.""`-------`"".-------------.
: \033[1;92m     HOPE YOU ENJOY MR MOHSIN ALI COMMAND..    \033[1;93m :
'-----------------------------------------' 
                ___)( )(___
               (((__) (__)))"""
